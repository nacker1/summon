...
switch ($type) {
	...
	case '1000':
		...
		$hList = $input['heros'];
		if( empty( $hList ) ){
			$hList = array( 10001,10002,10004,10005,10006,10007,10008,10009,10010,10011,10012,10013,10014,10015,10018,10019,10020,10021,10022,10023,10024,10025,10026,10027,10028,10029,10030,10031,10032,10033,10034,10036,10040 );
		}
		foreach ( $hList as $v ) {
