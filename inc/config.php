 ...
 **/
	...
	define('STRIKE_TIMES'						,10);				 #战争学院敲醒功能默认美中间隔时间  30分钟

	#============= log打印 =================                ===================

	define('LOG_LEVEL', 4);											 #打印日志的等级  0 = LEVEL_FATAL，1 = LEVEL_ERROR, 2 = LEVEL_WARN，3 = LEVEL_INFO，4 = LEVEL_DEBUG  4以上的数字为所有日志
